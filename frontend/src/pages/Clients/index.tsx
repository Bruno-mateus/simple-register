import { ChangeEvent, FormHTMLAttributes, HTMLInputTypeAttribute, InputHTMLAttributes, useContext, useEffect, useState } from "react";
...
export function Clients(){
    ...
    const {clients,getClients,deleteClient} = useContext(ClientContext)

    
    const [clientID, setClientID] = useState<string>("")
   
    const [openEditFormClient,setOpenEditFormClient] = useState<boolean>(false)
    ...
    return(
        ...
        <FormEditClientContainer formOpen={openEditFormClient?'true':'false'}>
                    ...
                    clients.map(client =>{
                        ...
                        <ClientCard key={client.id}>
                         ...
                         onClick={()=>{
                            ...
                            setOpenEditFormClient(true)
                            setClientID(client.id)
                          
                            setValue("birthDate", client.birthDate.substring(0,10))
